...
sealed class TestDestination(
    ...
    open val testDestinationType: Type
) {
...
data class LoggingDestination(
    @JsonProperty("test_destination_type")
    override val testDestinationType: Type = Type.LOGGING,
    @JsonProperty("logging_config")
    val loggingConfig: LoggingConfig = FirstNEntriesConfig()
) : TestDestination(testDestinationType)

@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "logging_type")
@JsonSubTypes(
...
sealed class LoggingConfig(
    ...
    open val loggingType: Type = Type.FIRST_N
) {
...
data class FirstNEntriesConfig(
    @JsonProperty("logging_type")
    override val loggingType: Type = Type.FIRST_N,
...
data class EveryNthEntryConfig(
    @JsonProperty("logging_type")
    override val loggingType: Type = Type.EVERY_NTH,
...
data class RandomSamplingConfig(
    @JsonProperty("logging_type")
    override val loggingType: Type = Type.RANDOM_SAMPLING,
...
data class SilentDestination(
    @JsonProperty("test_destination_type")
    override val testDestinationType: Type = Type.SILENT
) : TestDestination(testDestinationType)

data class ThrottledDestination(
    @JsonProperty("test_destination_type")
    override val testDestinationType: Type = Type.THROTTLED,
...
data class FailingDestination(
    @JsonProperty("test_destination_type")
    override val testDestinationType: Type = Type.FAILING,

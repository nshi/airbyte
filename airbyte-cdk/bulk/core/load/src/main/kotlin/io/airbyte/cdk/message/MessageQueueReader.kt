...
/**
 * A reader should provide a byte-limited flow of messages
 * of the underlying type. The flow should terminate when
 * maxBytes has been read, or when the stream is complete.
 */
...
class DestinationMessageQueueReader(
    ...
    override suspend fun readChunk(key: DestinationStream, maxBytes: Long):

...
/**
 * Implementor interface. Extended this only if you need
 * to perform initialization and teardown *across all streams*,
 * or if your per-stream operations need shared global state.
 *
 * If initialization can be done on a per-stream basis, implement
 * @[StreamLoaderFactory] instead.
 */

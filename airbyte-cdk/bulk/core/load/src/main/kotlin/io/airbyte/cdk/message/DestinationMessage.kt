...
class DestinationMessageFactory(
    ...
    fun fromAirbyteMessage(message: AirbyteMessage): DestinationMessage {
        return when (message.type) {
            AirbyteMessage.Type.RECORD -> DestinationRecord(
                stream = catalog.getStream(
                ...
                when (message.state.type) {
                    ...
                    AirbyteStateMessage.AirbyteStateType.GLOBAL ->
                        DestinationGlobalState(
                            ...
                            streamStates = message.state.global.streamStates.map {
    ...
    private fun fromAirbyteStreamState(streamState: AirbyteStreamState): DestinationStateMessage.StreamState {

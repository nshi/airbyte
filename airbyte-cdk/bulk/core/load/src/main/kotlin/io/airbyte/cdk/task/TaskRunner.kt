...
/**
 * A Task is a unit of work that can be executed concurrently.
 * Even though we aren't scheduling threads or enforcing
 * concurrency limits here, launching tasks from a queue
 * in a dedicated scope frees the caller not to have to
 * await completion.
 *

...
class DestinationMesssageDeserializerTest {
    ...
    class RecordMessageFactory(
        ...
        fun make(): Pair<AirbyteMessage, DestinationMessage> {
            ...
            val expectedOutput = DestinationRecord(
    ...
    class EndOfStreamMessageFactory(
        ...
        fun make(): Pair<AirbyteMessage, DestinationMessage> {
            ...
            val expectedOutput = DestinationStreamComplete(
                stream = DestinationStream(
                    descriptor = DestinationStream.Descriptor(
                        namespace = namespace,
                        name = name,
    ...
    class StreamStateMessageFactory(
        ...
        fun make(): Pair<AirbyteMessage, DestinationMessage> {
            val input = AirbyteMessage()
                ...
                .withState(
                    AirbyteStateMessage()
                        .withSourceStats(
                            AirbyteStateStats()
                                .withRecordCount(recordCount.toDouble())
                        )
            ...
            val expectedOutput = DestinationStreamState(
                ...
                sourceStats = DestinationStateMessage.Stats(
    ...
    class GlobalStateMessageFactory(
        val state: JsonNode = JsonNodeFactory.instance.objectNode().put("type", "object"),
        val recordCount: Long = 1001,
        val streams: List<Pair<String, String>> = listOf(
        ...
        fun make(): Pair<AirbyteMessage, DestinationMessage> {
                    ...
                    AirbyteStateMessage()
                        ...
                        .withGlobal(
                            AirbyteGlobalState()
                                ...
                                .withStreamStates(streams.map { (namespace, name) ->
                                    AirbyteStreamState()
                                        .withStreamState(JsonNodeFactory.instance.objectNode().put(namespace, name))
                                        .withStreamDescriptor(
                                            StreamDescriptor()
                                                .withNamespace(namespace)
                                                .withName(name)
            ...
            val expectedOutput = DestinationGlobalState(
                sourceStats = DestinationStateMessage.Stats(
                    recordCount = recordCount
                ),
                state = state,
                streamStates = streams.map { (namespace, name) ->
    ...
    class TestDeserializationArgumentsProvider : ArgumentsProvider {
        override fun provideArguments(context: ExtensionContext): Stream<out Arguments> {
            return Stream.of(
                RecordMessageFactory().make(),
                EndOfStreamMessageFactory().make(),
                StreamStateMessageFactory().make(),
                GlobalStateMessageFactory().make()
            ).map { Arguments.of(it) }
        }
    }
